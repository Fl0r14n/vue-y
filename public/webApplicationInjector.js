        ...
        function (t) {
          ...
          !(function (t, e) {
            if (
              ...
              if (e.properties) for (var n in e.properties) e.properties.hasOwnProperty(n) && (window.smartedit[n] = e.properties[n])
    ...
    var r = n(0),
      o = (function () {
        ...
        return (
          ...
          (t.whitelistingConfigRegex = new RegExp(/^(([-*a-zA-Z0-9]+[.])*([-a-zA-Z0-9]+[.]))?[-a-zA-Z0-9]+(:[0-9]{1,5})$/)),
