import { CartEndpoint } from '@/yapi/b2c/cart.service'
import type { RequestData, SaveCartResultData } from '@/yapi/models'

export class SaveCartService extends CartEndpoint {
  /**
