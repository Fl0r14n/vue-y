import { ProductEndpoint } from '@/yapi/b2c'
import type { CCPAttributeRequestData, CCPConfigurationData } from '@/yapi/models'

export class CcpProductService extends ProductEndpoint {
  /**
