import type { OrderApprovalData, OrderApprovalDecisionData, OrderApprovalListData, RequestData, SortableRequestData } from '@/yapi/models'
import { AuthRestClient } from '@/yapi/rest'

export class OrderApprovalService extends AuthRestClient {
  getEndpoint() {
